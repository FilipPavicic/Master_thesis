...
def model(image_shape,  in_channels, out_channels, label_shape=(10, 10), concat_channels=[2, 2], channels=[8, 8, 16, 16, 32], dropout=None, kernel_initializer='glorot_uniform'):
    # inputs
    ...
    concat32 = layers.Conv2DTranspose(concat_channels[0], kernel_size=14, strides=2,  activation=keras.layers.LeakyReLU(alpha=0.2))(concat10)
    concat128 = layers.Conv2DTranspose(concat_channels[0], kernel_size=3, strides=4, padding="same", activation=keras.layers.LeakyReLU(alpha=0.2))(concat32)
